...
namespace MilkAndMoon.Api.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_id = table.Column<Guid>(type: "uuid", nullable: false),
                    left_amount = table.Column<decimal>(
                        type: "numeric(3,1)",
                        precision: 3,
                        scale: 1,
                        nullable: false,
                    ...
                    right_amount = table.Column<decimal>(
                        type: "numeric(3,1)",
                        precision: 3,
                        scale: 1,
                        nullable: false,
                    ...
                    end_time = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    created_at = table.Column<DateTimeOffset>(
                    ...
                    start_time = table.Column<DateTimeOffset>(
                        type: "timestamp with time zone",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    stool_color = table.Column<string[]>(
                        type: "text[]",
                        nullable: false,
                        defaultValueSql: "'{}'"
                    ),
                    stool_texture = table.Column<string[]>(
                        type: "text[]",
                        nullable: false,
                        defaultValueSql: "'{}'"
                    ),
                    rash = table.Column<string>(type: "text", nullable: true),
                    rash_location = table.Column<string[]>(
                        type: "text[]",
                        nullable: false,
                        defaultValueSql: "'{}'"
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    bottle_size = table.Column<decimal>(
                        type: "numeric(3,1)",
                        precision: 3,
                        scale: 1,
                        nullable: false,
                    ...
                    breast_side = table.Column<string[]>(
                        type: "text[]",
                        nullable: false,
                        defaultValueSql: "'{}'"
                    ),
                    milk_type = table.Column<string[]>(
                        type: "text[]",
                        nullable: false,
                        defaultValueSql: "'{}'"
                    ),
                    milk_consumed = table.Column<decimal>(
                        type: "numeric(3,1)",
                        precision: 3,
                        scale: 1,
                        nullable: false,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    wake_reasons = table.Column<string[]>(
                        type: "text[]",
                        nullable: false,
                        defaultValueSql: "'{}'"
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "diaper_logs");

            migrationBuilder.DropTable(name: "feed_logs");

            migrationBuilder.DropTable(name: "pump_logs");

            migrationBuilder.DropTable(name: "sleep_logs");

            migrationBuilder.DropTable(name: "babies");
